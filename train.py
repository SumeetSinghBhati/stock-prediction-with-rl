...
parser.add_argument('--model_name', action="store", dest="model_name", default='DDPG', help="model name")
parser.add_argument('--stock_name', action="store", dest="stock_name", default='facebook_2020_2022', help="stock name")
